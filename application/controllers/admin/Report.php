...
class Report extends MY_Controller
{
    ...
    public function exportSales($filter, $startFrom = '', $endPeriod = '', $month = '', $year = '')
    {
        if ($filter == "date") {
    ...
    public function exportPdfReportSales($filter, $startFrom = '', $endPeriod = '', $month = '', $year = '')
    {
    ...
    public function requestTrackingProduct()
    {
        ...
        //     ->joinBetweenProductInTransaction()
