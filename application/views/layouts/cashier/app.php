...
<body class="body-bg" data-url="<?= base_url(); ?>">
    ...
    <div class="horizontal-main-wrapper">
        ...
        <?php $this->load->view('layouts/cashier/_header'); ?>
        <!-- main header area end -->

        <!-- header area start (navbar) -->
        <?php $this->load->view('layouts/cashier/_navbar'); ?>
        <!-- header area end -->
        ...
        <!-- start modal -->
        <?php $this->load->view('layouts/cashier/_modal'); ?>
        <!-- modal end -->

        <!-- footer area start-->
        <?php $this->load->view('layouts/cashier/_footer'); ?>
        <!-- footer area end-->
    ...
    <!-- offset area start -->
    <?php $this->load->view('layouts/cashier/_offset'); ?>
    <!-- offset area end -->

    <!-- script -->
    <?php $this->load->view('layouts/cashier/_script'); ?>
    <!-- end script -->
</body>
