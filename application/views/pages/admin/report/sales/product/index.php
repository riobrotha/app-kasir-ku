            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control select2" id="selectFilterSalesProduct">
                            <option></option>
                    ...
                    <!-- date area -->
                    <form action="#" method="POST" class="mb-4" id="formReportSalesProduct">
                        <div id="dateAreaaSalesProduct" class="mt-4">
                        ...
                        <!-- month area -->
                        <div id="monthAreaSalesProduct" class="mt-4">
                            <div class="row">
                                <div class="col-4">
                                    <div class="form-group">
                        ...
                        <div id="yearAreaSalesProduct" class="mt-4">
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        <label class="col-form-label">Select Year :</label>
                        ...
                        <button type="submit" class="btn btn-rounded btn-purple float-right mb-4 btn-submit-report-sales-product">Submit</button>
                    </form>
                    ...
                    <div class="tableReportSalesProduct" style="margin-top: 65px;">
