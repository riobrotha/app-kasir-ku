        ...
        <tbody>
            ...
            foreach ($content as $row) : ?>
                <tr>
                    ...
                    <td>
                        <button class="btn btn-rounded btn-info" id="btnEditProductIn" data-id="<?= $row->id_product_in; ?>" data-toggle="tooltip" data-placement="left" title="Edit"><i class="fa fa-edit fa-2x"></i></button>
