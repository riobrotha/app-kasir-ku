                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu dropdown-menu-right animate slideIn">
                                    <button class="dropdown-item" type="button" id="btnEditMedicalRecord" data-id="<?= $row->id; ?>"><i class="ti-pencil mr-2 text-info"></i><strong>Edit Medical Record</strong></button>
                                </div>
                            </div>
                        </div>
